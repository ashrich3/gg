...
# Canon rules for Gossip Girl universe
canon_rules = {
    "noRomanceBetweenChuckAndSerena": "Chuck and Serena never had romantic or sexual involvement. Any generated scenes must reflect their sibling-style dynamic.",
    "serenaTone": "Serena is magnetic, charming, emotionally complex. She should not be portrayed as cold, cruel, or calculating."
}
